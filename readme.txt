...
1. 欧路生词本
   ...
   - 支持上下滚动浏览单词。
   - 点击单词可进入详情页。
   - 可按需导入完整覆盖初中词汇的高中词书，以及四级、六级和托福词书。
   - 内置词书与欧路单词统一浏览，并自动去除重复单词。
...
5. 掌握进度与归档
   - 中文意思和发音练习共享每个单词的正确次数。
   - 累计正确 3 次后，单词自动移出两种练习。
   - 归档单词可在“已归档单词”页面浏览和打开详情。
   - 自动同步到欧路词典的“已归档单词”分组。
   - 网络失败时保留本机归档，并在下次同步时自动重试。
   - 学习成果页面按词书列出已正确完成的中文意思和发音练习。
